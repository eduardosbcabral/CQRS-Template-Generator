    ...
    class Program
    {
        ...
        static List<Tuple<string, string, string>> GetTemplateFiles() =>
            new List<Tuple<string, string, string>>
            {
                ...
                new Tuple<string, string, string>("Core\\Domain\\Events\\EntityName", "EntityNameRegisteredEvent", ".cs"),
                new Tuple<string, string, string>("Core\\Domain\\Events\\EntityName", "EntityNameRemovedEvent", ".cs"),
                new Tuple<string, string, string>("Core\\Domain\\Events\\EntityName", "EntityNameUpdatedEvent", ".cs"),
                ...
                new Tuple<string, string, string>("Core\\Domain\\Validations\\EntityName", "EntityNameValidation", ".cs"),
                new Tuple<string, string, string>("Core\\Domain\\Validations\\EntityName", "RegisterEntityNameCommandValidation", ".cs"),
                new Tuple<string, string, string>("Core\\Domain\\Validations\\EntityName", "RemoveEntityNameCommandValidation", ".cs"),
                new Tuple<string, string, string>("Core\\Domain\\Validations\\EntityName", "UpdateEntityNameCommandValidation", ".cs"),
